...
module.exports = configure(function (/* ctx */) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'Tracvac Administrator',
        short_name: 'Tracvac Administrator',
        description: 'User-friendly management interface for Tracvac\'s backend',
        display: 'standalone',
